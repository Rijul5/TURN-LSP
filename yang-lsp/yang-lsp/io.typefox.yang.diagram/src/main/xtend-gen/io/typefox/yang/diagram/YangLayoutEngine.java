...
public class YangLayoutEngine extends ElkLayoutEngine {
  private static final Logger LOG = Logger.getLogger(YangLayoutEngine.class);
  ...
  protected void applyEngine(final ElkNode elkGraph) {
    boolean _isTraceEnabled = YangLayoutEngine.LOG.isTraceEnabled();
    if (_isTraceEnabled) {
      YangLayoutEngine.LOG.info(this.toXMI(elkGraph));
    }
