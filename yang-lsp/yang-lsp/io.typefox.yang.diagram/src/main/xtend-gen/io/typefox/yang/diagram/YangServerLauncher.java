...
public class YangServerLauncher extends ServerLauncher {
  @Data
  public static class LanguageClientAppender extends AppenderSkeleton {
    ...
    public boolean equals(final Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      YangServerLauncher.LanguageClientAppender other = (YangServerLauncher.LanguageClientAppender) obj;
      if (this.client == null) {
  ...
  public static void main(final String[] args) {
    ...
    final com.google.inject.Module _function = (Binder it) -> {
      it.<ServerLauncher>bind(ServerLauncher.class).to(YangServerLauncher.class);
      ...
      it.<ProjectManager>bind(ProjectManager.class).to(YangProjectManager.class);
    };
    ...
    try {
      ...
      final Procedure1<Logger> _function_1 = (Logger it) -> {
        ...
        final Procedure1<AsyncAppender> _function_2 = (AsyncAppender it_1) -> {
          YangServerLauncher.LanguageClientAppender _languageClientAppender = new YangServerLauncher.LanguageClientAppender(client);
