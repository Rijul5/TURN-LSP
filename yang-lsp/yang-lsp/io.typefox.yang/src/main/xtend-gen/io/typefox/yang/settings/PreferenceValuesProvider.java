...
public class PreferenceValuesProvider implements IPreferenceValuesProvider {
  ...
  public static IPreferenceValues createPreferenceValues(final URI projectURI) {
    try {
      ...
      final Path userSettings = userHome.resolve(".yang").resolve("yang.settings");
      ...
      final Path workspaceSettings = Paths.get(workspaceDirectory).resolve("yang.settings");
      ...
      final Path projectSettings = Paths.get(projectDirectory).resolve("yang.settings");
