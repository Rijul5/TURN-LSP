...
public class IssueCodes extends ConfigurableIssueCodesProvider {
  ...
  public static class DocumentedPreferenceKey extends PreferenceKey {
    ...
    public DocumentedPreferenceKey(final String arg0, final String arg1, final String documentation) {
      super(arg0, arg1);
  ...
  public static final String BAD_INCLUDE_YANG_VERSION = new Function0<String>() {
    public String apply() {
      ...
      _builder.newLine();
      String _error = IssueCodes.error("bad-include-yang-version", _builder);
      return _error;
    }
  }.apply();
  ...
  public static final String BAD_IMPORT_YANG_VERSION = new Function0<String>() {
    public String apply() {
      ...
      _builder.append("Issues code when there is an inconsistency between a module\'s version and the version of the included modules.");
      _builder.newLine();
      String _error = IssueCodes.error("bad-import-yang-version", _builder);
      return _error;
    }
  }.apply();
